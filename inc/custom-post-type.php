...
function premium_contact_add_meta_box() {
    add_meta_box( 'contact_email', 'User Email', 'premium_contact_email_callback', 'premium-contact', 'side', 'high' );
}
...
function premium_contact_email_callback( $post ) {
    ...
    echo '<input type="email" id="premium_contact_email_field" name="premium_contact_email_field" value="' . esc_attr( $value ) . '" size="25" />';
