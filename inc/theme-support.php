...
function premium_posted_footer() {
    ...
    if ( comments_open() ) {
        ...
        $comments = '<a href="'. get_comments_link() .'">' . $comments . ' <span class="fa fa-comments"></span></a>';
    } else {
        $comments = __('Comments are closed');
    }

    return '<div class="post-footer-container"><div class="row"><div class="col-xs-12 col-sm-6">'. get_the_tag_list( '<div class="tags-list"><span class="fa fa-tags"></span> ', ' ', '</div>') .'</div><div class="col-xs-12 col-sm-6">'. $comments .'</div></div></div>';
}